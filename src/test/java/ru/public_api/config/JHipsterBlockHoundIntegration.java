...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ru.public_api.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ru.public_api.security.DomainUserDetailsService", "createSpringSecurityUser");
